...
public class DependencyRepositoryTest {
	...
	public void findByRequirementIdWithParamsWorksWhenIdsGiven() {
		...
		List<Dependency> dependencies = dependencyRepository.findByRequirementIdWithParams(ids, null, null, null, null,
				null);
		assertEquals(2, dependencies.size());
	}
	...
	public void findByRequirementIdWithParamsWorksWhenParamsNull() {
		...
		List<Dependency> dependencies = dependencyRepository.findByRequirementIdWithParams(null, null, null, null, null,
				null);
	...
	public void findByRequirementIdWithParamsWorksWhenIncludeRejectedTrue() {
		...
		List<Dependency> dependencies = dependencyRepository.findByRequirementIdWithParams(ids, null, null, null, true,
				null);
